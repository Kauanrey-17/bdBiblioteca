...
namespace bdBiblioteca.Controllers
{
    public class LivroController : Controller
    {
        ...
        public IActionResult Criar(Livros vm)
        {
            ...
            cmd.Parameters.AddWithValue("p_editor", (object?)vm.EditoraId ?? DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("p_quantidade", (object?)vm.QuantidadeTotal);
            cmd.ExecuteNonQuery();
        ...
        public IActionResult Editar(Livros model)
        {
            ...
            cmd.Parameters.AddWithValue("p_novo_valor", model.QuantidadeTotal);
            cmd.ExecuteNonQuery();
        ...
        public IActionResult Excluir (int id)
        {
            ...
            try
            {
                ...
                // ex. : signal 'não é possivel excluir: livro utilizado em emprestimos.
